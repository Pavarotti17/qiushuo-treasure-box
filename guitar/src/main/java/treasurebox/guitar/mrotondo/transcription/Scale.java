...
public class Scale {
    ...
    public static Scale  majorScale         = new Scale(new Interval[] { Interval.MAJOR_SECOND,
            ...
            Interval.MAJOR_SECOND, Interval.MAJOR_SECOND, Interval.MINOR_SECOND }, "Major");

    public static Scale  naturalMinorScale  = new Scale(new Interval[] {
            Interval.MAJOR_SECOND, // TODO: test
            Interval.MINOR_SECOND, Interval.MAJOR_SECOND, Interval.MAJOR_SECOND,
            Interval.MINOR_SECOND, Interval.MAJOR_SECOND, Interval.MAJOR_SECOND }, "Natural Minor");

    public static Scale  harmonicMinorScale = new Scale(new Interval[] {
            Interval.MAJOR_SECOND, // TODO: test (buggy)
            Interval.MINOR_SECOND, Interval.MAJOR_SECOND, Interval.MAJOR_SECOND,
            Interval.MINOR_SECOND, Interval.MINOR_THIRD, Interval.MINOR_SECOND }, "Harmonic Minor");

    public static Scale  melodicMinorScale  = new Scale(new Interval[] {
            Interval.MAJOR_SECOND, // TODO: test (buggy)
            Interval.MINOR_SECOND, Interval.MAJOR_SECOND, Interval.MAJOR_SECOND,
            Interval.MAJOR_SECOND, Interval.MAJOR_SECOND, Interval.MINOR_SECOND }, "Melodic Minor");
