package treasurebox.guitar.mrotondo.ui;
...
public class ToneLinesUI extends JPanel implements MouseMotionListener, MouseListener {
    ...
    public void mouseMoved(MouseEvent e) {
        sineGenerator.setFrequency((double) e.getY() / this.getHeight() * (maxFreq - minFreq)
                                   + minFreq);
    ...
    public void mouseClicked(MouseEvent e) {
        System.out
            .println("Freq: "
                     + ((double) e.getY() / this.getHeight() * (maxFreq - minFreq) + minFreq));
